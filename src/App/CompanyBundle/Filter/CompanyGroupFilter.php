...
class CompanyGroupFilter extends BaseFilter
{

    protected $columns = [
        'no'   => 'App\CompanyBundle\Entity\CompanyGroup.id',
        'id'   => 'App\CompanyBundle\Entity\CompanyGroup.id',
        'name' => 'App\CompanyBundle\Entity\CompanyGroup.title',
    ];
    ...
    public function getDataFormatter($data, $countRows)
    {
        ...
        foreach ($data as $entity) {
            $results[$count][]           = $renderer->render('AppCompanyBundle:DtModelStyle/CompanyGroup:noFormatter.html.twig', ['entity' => $entity,]);
            $results[$count][]           = $renderer->render('AppCompanyBundle:DtModelStyle/CompanyGroup:idFormatter.html.twig', ['entity' => $entity,]);
            $results[$count][]           = $renderer->render('AppCompanyBundle:DtModelStyle/CompanyGroup:nameFormatter.html.twig', ['entity' => $entity,]);
    ...
    public function getQueryBuilder(Request $request)
    {
        ...
        $qb = $this->getEntityManager()->getRepository('AppCompanyBundle:CompanyGroup')->getQueryBuilderByCriteria($criteria);
