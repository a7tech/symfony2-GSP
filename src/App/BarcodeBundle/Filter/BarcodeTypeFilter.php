...
namespace App\BarcodeBundle\Filter;

use Symfony\Component\HttpFoundation\Request;
use App\CoreBundle\Filter\Filter as BaseFilter;

class BarcodeTypeFilter extends BaseFilter
{

    protected $columns = [
        'no'   => 'App\BarcodeBundle\Entity\BarcodeType.id',
        'id'   => 'App\BarcodeBundle\Entity\BarcodeType.id',
        'name' => 'App\BarcodeBundle\Entity\BarcodeType.name',
    ];
    ...
    public function getDataFormatter($data, $countRows)
    {
        ...
        foreach ($data as $entity) {
            $results[$count][]           = $renderer->render('AppBarcodeBundle:DtModelStyle/BarcodeType:noFormatter.html.twig', ['entity' => $entity,]);
            $results[$count][]           = $renderer->render('AppBarcodeBundle:DtModelStyle/BarcodeType:idFormatter.html.twig', ['entity' => $entity,]);
            $results[$count][]           = $renderer->render('AppBarcodeBundle:DtModelStyle/BarcodeType:nameFormatter.html.twig', ['entity' => $entity,]);
    ...
    public function getQueryBuilder(Request $request)
    {
        ...
        $qb = $this->getEntityManager()->getRepository('AppBarcodeBundle:BarcodeType')->getQueryBuilderByCriteria($criteria);
