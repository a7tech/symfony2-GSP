...
class InvoiceProductTaxesSubscriber implements EventSubscriberInterface
{
    /**
     * @var EntityManager
     */
    ...
    public function addTaxes(FormEvent $event)
    {
        ...
        $account_product = $data instanceof InvoiceProduct ?
            $data->getProduct() :
            $this->entity_manager->getRepository('AppAccountProductBundle:AccountProduct')->getById($data['product']);
