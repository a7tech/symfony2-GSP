...
namespace App\PaymentBundle\Filter;
...
class PaymentMethodFilter extends BaseFilter
{
    ...
    protected $columns = [
        'id'   => 'App\PaymentBundle\Entity\PaymentMethod.id',
        'name' => 'App\PaymentBundle\Entity\PaymentMethod.name',
    ];
    ...
    public function getDataFormatter($data, $countRows)
    {
        ...
        foreach ($data as $entity) {
            $results[$count][]           = $renderer->render('AppPaymentBundle:DtModelStyle/PaymentMethod:idFormatter.html.twig', ['entity' => $entity,]);
            $results[$count][]           = $renderer->render('AppPaymentBundle:DtModelStyle/PaymentMethod:nameFormatter.html.twig', ['entity' => $entity,]);
    ...
    public function getQueryBuilder(Request $request)
    {
        ...
        $qb = $this->getEntityManager()->getRepository('AppPaymentBundle:PaymentMethod')->getQueryBuilderByCriteria($criteria);
